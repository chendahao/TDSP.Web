          ...
          <v-tooltip bottom>
            <template v-slot:activator="{ on }">
              <v-icon
                color="info"
                v-on="on"
                @click="edit(item.groupId,'detail')"
              >
                view_quilt
              </v-icon>
            </template>
          ...
          <v-tooltip bottom>
            <template v-slot:activator="{ on }">
              <v-icon
                color="warning"
                v-on="on"
                @click="deleteitem(item.groupNo,item.groupId)"
              >
                delete
              </v-icon>
            </template>
...
export default {
  ...
  data () {
    return {
      loading: false,
      headers: [
        { text: '组编号', sortable: true, value: 'groupNo' },
        { text: '组长度(m)', sortable: true, value: 'length' },
        { text: '最大载重量', sortable: true, value: 'maxLoadWeight' },
        { text: '最小载重量', sortable: true, value: 'minLoadWeight' },
        { text: '所属码头', sortable: true, value: 'parentWharf.wharfNo' },
