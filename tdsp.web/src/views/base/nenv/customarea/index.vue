  ...
  <div>
    ...
    <v-container fluid>
      <v-data-table
        ...
        :dense="tableDense"
      >
        <!-- <template v-slot:item.isMonitoring="{ item }">
          {{ item.isNext==1?'是':'否' }}
        </template> -->
  ...
  data () {
    return {
      headers: [
        ...
        // { text: '开启监控', sortable: false, value: 'isMonitoring' },
