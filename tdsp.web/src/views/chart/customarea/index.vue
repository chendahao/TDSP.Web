<template>
  <div>
    <PageHeader headertitle="自定义区域船舶">
      <v-spacer></v-spacer>
    </PageHeader>
    <v-container fluid>
...
<script>
import CustomAreaApi from '@/api/navenv/CustomAreaApi'
...
export default {
  ...
  methods: {
    ...
    getchartdata: async function () {
      let item = await api.GetCustomAreaFlowById(this.item, this.date1, this.date2)
      let data = item.data
